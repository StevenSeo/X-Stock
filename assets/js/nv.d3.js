    ...
    function layer(selection) {
        selection.each(function(data) {
            ...
            layer.renderGuideLine = function(x,y) {
				...
				x = (x != null) ? nv.utils.NaNtoZero(x) : '';
				//y = (y != null) ? nv.utils.NaNtoZero(y) : 0;
				
				//var crossPoint = [{"x1" : x, "x2" : x, "y1" : availableHeight, "y2" : 0}, {"x1" : availableWidth, "x2" : 0, "y1" : y, "y2" : y}];
				var crossPoint = [{"x1" : x}];
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                data
                    ...
                    .forEach(function(series,i) {
                        ...
                        if (typeof singlePoint === 'undefined') singlePoint = point;
                        if (typeof pointXLocation === 'undefined') pointXLocation = chart.xScale()(chart.x()(point,pointIndex));
						if (typeof pointYLocation === 'undefined') pointYLocation = chart.yScale()(chart.y()(point,pointIndex));
                        allData.push({
                            key: series.key,
                            value: chart.y()(point, pointIndex),
                            color: color(series,series.seriesIndex)
